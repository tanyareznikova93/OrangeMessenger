package com.example.orangemessenger.database
...
import com.example.orangemessenger.utilits.AppValueEventListener
...
fun initFirebase(){
    ...
    REF_DATABASE_ROOT =  FirebaseDatabase.getInstance().getReferenceFromUrl("https://orangemessenger-b8494-default-rtdb.firebaseio.com/")
    USER = User()
    CURRENT_UID = AUTH.currentUser?.uid.toString()
    //REF_STORAGE_ROOT = FirebaseStorage.getInstance().reference
    REF_STORAGE_ROOT = FirebaseStorage.getInstance().getReferenceFromUrl("gs://orangemessenger-b8494.appspot.com/")
}
...
fun createGroupInDatabase(
    ...
    val pathStorage = REF_STORAGE_ROOT.child(FOLDER_GROUPS_IMAGE).child(groupKey)
